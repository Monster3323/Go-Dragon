...
void Display(piece checkerboard[19][19])
{
	...
	for (i = 0; i < 19; i++)
	{
		for (j = 0; j < 19; j++)
		{
			...
			if (checkerboard[i][j].data == 6) cout<<"┬─";
			if (checkerboard[i][j].data == 7) cout<<"┴─";
			if (checkerboard[i][j].data == 8) cout<<"├─";
			if (checkerboard[i][j].data == 9) cout<<"┤";
			if (checkerboard[i][j].data == 10) cout<<"┼─";
			if (checkerboard[i][j].data == 0) cout<<"○";
			if (checkerboard[i][j].data == 1) cout<<"●";
		}
		printf("\n");
	}
}
